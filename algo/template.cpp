    ...
    if [ $only_compile == compile ]; then
        g++ -std=c++20 $me.cpp -o $me -Wall -O2 -Wextra -Wno-sign-conversion -Wconversion -Wshadow -Wl,-stack_size -Wl,0x20000000
        exit
    fi
    if [ $only_compile == debug ]; then
        g++ -std=c++20 -DLOCAL $me.cpp -o $me -Wall -O2 -Wextra -Wno-sign-conversion -Wconversion -Wshadow -Wl,-stack_size -Wl,0x20000000
        exit
    fi
    g++ -std=c++20 -DLOCAL $me.cpp -o $me -Wall -O2 -Wextra -Wno-sign-conversion -Wconversion -Wshadow -Wl,-stack_size -Wl,0x20000000
    if test -f $me; then
